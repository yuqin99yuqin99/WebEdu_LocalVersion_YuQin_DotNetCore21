...
namespace EDSS.Controllers
{
    public class TryInterfaceTypeController : Controller
    {
       ...
       // interface IPrinter : IPrint, IPrinterName        { }
    ...
    internal struct TryStructure//此部分代码建议转化为internal class TryStructure:ValueType进行理解，有利于理解结构类型（在此是TryStructure）乃是由System.Objecet←System.ValueType方式继承扩展而来的特殊类类型，因为结构类型的父类是System.ValueType，所以结构类型属于拷贝类型，而且不允许被进一步继承扩展。因此比相应的类类型更加体现性能优势。
    {
