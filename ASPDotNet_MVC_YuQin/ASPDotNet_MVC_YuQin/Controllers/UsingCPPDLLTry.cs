...
{
    public class UsingCPPDLLTryController : Controller
    {
        ...
        public UsingCPPDLLTryController(IHostingEnvironment hostingEnvironment)//通过注入 IHostingEnvironment 服务对象来取得Web根目录和内容根目录的物理路径
        {
