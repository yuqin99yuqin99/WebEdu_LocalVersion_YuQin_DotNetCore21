<%
 ...
 sMusicPath = Request("sMusicPath") '部分保存路径
...
<form method="POST" id="form1" action="upMusic.asp?sMusicPath=<%=sMusicPath%>" >
...
<% 
  '提交后把它拷贝到指定目录下,并返回在线编辑的值
   ...
   If Not Request("ImageName")="" Then
      ...
      sFilePath = Server.mapPath("../../../"+sMusicPath)
      ...
      Response.write "<script>parent.fnInsertMusic('" + sRndFileName + "');</script>"
   End If
