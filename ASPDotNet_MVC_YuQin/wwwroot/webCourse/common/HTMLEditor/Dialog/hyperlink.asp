...
<tr>
	...
	<tr>
		...
		<iframe id="oHyperlink" name="oHyperlink" src="uploadhyperlink.asp?sHyperlinkPath=<%=sHyperlinkPath%>" width="300" height="22" border="0" frameborder="0" scrolling="no"></iframe></td>
	</tr>
