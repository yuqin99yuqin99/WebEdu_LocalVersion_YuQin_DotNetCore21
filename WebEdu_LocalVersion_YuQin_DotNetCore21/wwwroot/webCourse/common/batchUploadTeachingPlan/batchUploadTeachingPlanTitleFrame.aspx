...
<script  language="C#" runat="server">
	...
	{
	  	sPath=Server.MapPath("../../lessons/content/teachingPlan").Replace("\\","\\\\");
	}
</script>
<html>
...
<table style="width:100%;height:100%;border:0px none;padding:0;margin:0;" id="sTableBook">
  <tr id="sTrTitle" style="width:100%;height:30">
    <td valign="top" width="22%">选择批量教案所在的文件夹:<br>
...
　</td>
    ...
    <input type="button" value="全选" name="sCheckAll" id="sCheckAll" onclick='parent.frames("sIframeBottom").fnCheckAll();'>
