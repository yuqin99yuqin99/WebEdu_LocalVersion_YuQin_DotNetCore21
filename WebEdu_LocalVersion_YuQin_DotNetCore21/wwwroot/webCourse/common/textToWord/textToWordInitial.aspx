...
<frameset rows="55,*" id="sFramesetBook" name="sFramesetBook" style="border: 0px ; padding-bottom: 1px; border-collapse:collapse" framespacing="0" border="0" frameborder="0">
	<frame src="textToWordTitle.aspx" name="sIFrameTitle" id="sIFrameTitle" scrolling="no" noresize target="sIframeContents" style="border-right:1px dotted #800000; border-bottom:1px dotted #800000; ">
	<frameset cols="224,*" id="sFramesetMiddle" name="sFramesetMiddle">
		<frame src="../../lessons/contents.htm" name="sIframeContents" id="sIframeContents" scrolling="no" target="sIframeContent" style="border-right-style: dotted; border-right-width: 1px;border-right-color:#800000;">
