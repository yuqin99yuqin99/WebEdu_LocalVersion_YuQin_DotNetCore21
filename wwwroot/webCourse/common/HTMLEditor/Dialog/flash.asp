...
<tr>
	...
	<tr>
		<td colspan="2" height="32" valign="top">:flash文件:<iframe name="d_file" id="d_file" width="282" height="21" src="upflash.asp?sFlashPath=<%=sFlashPath%>" scrolling="no" border="0" frameborder="0">浏览器不支持嵌入式框架，或被配置为不显示嵌入式框架。</iframe>
