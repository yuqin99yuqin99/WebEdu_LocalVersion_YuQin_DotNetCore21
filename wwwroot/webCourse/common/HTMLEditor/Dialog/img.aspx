...
<script language="C#" runat="server">
	...
	{
	  sImagePath=Request.QueryString["sImagePath"].Replace("\\","\\\\");
...
function ReturnValue( pic )
{
	sFromUrl=pic;
	t_id = setTimeout("ReturnValue1()",2000);  
}
// 本窗口返回值
...
function ok(){
		...
		// 上传表单提交
		d_uploadiframe.Form1.Button1.click();
}
...
<tr>
	...
	<tr><td colspan=3 height=33>
		<iframe name="I1" width="300" height="23" id="d_uploadiframe" src="uploadpicture.aspx?sImagePath=<%=sImagePath%>" scrolling="no" border="0" frameborder="0">
