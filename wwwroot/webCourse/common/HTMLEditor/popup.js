...
var iChildNumber=oDiv.childNodes.length;
   ...
   window.oSrcElement=HtmlEdit.event.srcElement;//为什么要保存此事件对象？
   var iLeft =HtmlEdit.event.screenX+5;
   var iTop = HtmlEdit.event.screenY+5;
...
window.oPopup.show(iLeft,iTop,iMaxLength*13,iChildNumberDisplay*13);
