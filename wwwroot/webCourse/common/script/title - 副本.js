...
window.document.getElementById("sDownload").startDownload(window.sURLHeader+"common/popupTitle.htm",fnWritePopupContent);//不知道为什么直接调用parent.sURLHeader出错！必须固定initial.asp或initial.asp（既主界面文档）的放置位置，从而获得整个应用的URL根，其它文档中全部使用相对URL，便于维护和移植。
