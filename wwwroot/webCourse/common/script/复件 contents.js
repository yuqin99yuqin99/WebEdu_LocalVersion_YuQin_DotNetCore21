...
downLoad.startDownload(parent.sHTTPHeader+"common/popupContents.asp",fnOnDownLoad);//在没有父框架的情形下无法使用；
...
if(cLi[0].childNodes.length>2){
	var oInsertImage=window.document.createElement(sImageElementPlus);
}
else{
...
if(iLiLength>1){
	for(i=1;i<iLiLength-1;i++){
		...
		if(oLi.childNodes.length>2){
			var oInsertImage=document.createElement(sImageElementPlus);
									}
		else{
			var oInsertImage=document.createElement(sImageElementNo);
			}
...
function fnSave(){
	...
	//var bWillSaved=confirm("原目录文件将被覆盖,如果需要,请备份原目录文件,该文件的URL是"+'"'+"http://"+sPath+parent.sContentsName+'"'+"，物理路径是"+'"'+sPathContentshtmNowNow.substring(0,sPathContentshtmNowNow.length-2)+parent.sContentsName+'"');
	var bWillSaved=confirm("原目录文件将被覆盖,如果需要,请备份原目录文件,该文件的URL是"+'"'+"http://"+sPath+parent.sContentsName+'"'+"，物理路径是"+'"'+sPathContentshtmNowNow.substring(0,sPathContentshtmNowNow.lastIndexOf("Tempcontents.asp"))+parent.sContentsName+'"');
	...
	if(bWillSaved){
		...
		parent.frames("sIframeBottom").document.getElementById("docPath").value=parent.sContentsName;
		parent.frames("sIframeBottom").document.getElementById("sSaveContentsForm").action="../common/saveContents.asp";
...
function fnCopyPartResource(){
	...
	var sPhysicPath=sPathContentshtmNowNow.substring(0,sPathContentshtmNowNow.lastIndexOf("Tempcontents.asp"))+"contentsForCopyPartResource.asp";
	...
	parent.frames("sIframeBottom").document.getElementById("sCopyPartResourceForm").action="../common/copyPartResource/copyPartResourceSaveContents.asp";
...
try{//为内容框架修改又没有保存而刷新的程序被打断而设置！！！
	...
	if(event.srcElement.parentNode.attributes.getNamedItem("sFId").nodeValue==""){
		...
		if(event.srcElement.parentNode.parentNode===event.srcElement.parentNode.parentNode.parentNode.childNodes.item(0)&&event.srcElement.parentNode.parentNode.parentNode.parentNode.tagName.toUpperCase()==="DIV"){
			window.open("../options/contentStart.asp","sIframeContent",false);
																								}
		else{
			...
			if(sText==""){
					...
					window.open("../common/createText.asp?sFileName="+sFileName,"sIframeContent",false);
			}
			else{
				window.open("content/book/"+sText+"/"+sText+".asp","sIframeContent",true);
				}
			}
	}
	else{
		...
		if(event.srcElement.parentNode.parentNode===event.srcElement.parentNode.parentNode.parentNode.childNodes.item(0)&&event.srcElement.parentNode.parentNode.parentNode.parentNode.tagName.toUpperCase()==="DIV"){
			...
			if( sTextF==""){
					...
					window.open("../common/createTextForeign.asp?sFileName="+sFileName,"sIframeContent",false);
			}
			else{
				window.open("content/book_foreign/"+ sTextF+"/"+ sTextF+".asp","sIframeContent",true);
				}
			}
	}	
...
try{
	...
	if(event.srcElement.tagName.toUpperCase()=="SPAN"){
		...
		window.oPopup.show(iLeft,iTop,iMaxLength*13,iChildNumberDisplay*15);
	...
	if(window.oSrcElement.parentNode.parentNode===window.oSrcElement.parentNode.parentNode.parentNode.childNodes.item(0)&&window.oSrcElement.parentNode.parentNode.parentNode.parentNode.tagName.toUpperCase()==="DIV"){
		...
		if(window.oSrcElement.parentNode.attributes.getNamedItem("sFId").nodeValue==""){//国语状态
					...
					if(intTarget==intLi-1){//已经是最后一个条目，从头开始查询
						for(var j=0;j<intLi;j++ ){
							if(cLi[j].getElementsByTagName("A").item(0).attributes.getNamedItem("teachingPlan").nodeValue!=""){
								...
								showModelessDialog("../common/windowOrFullScreen_techingPlan.asp", window,"help:0;resizable:1;dialogWidth:"+screen.width*0.8+"px;dialogHeight:"+screen.height*0.5+"px;status:0;");	
								bIsHave=true;
								break;
							}
						}
			...
			if(sTeachingPlanName==""){
				...
				var sTeachingPlanName=window.oSrcElement.parentNode.attributes.getNamedItem("teachingPlanF").nodeValue;
				window.sTeachingPlan=sHeadUrl+"content/teachingPlan_foreign/"+sTeachingPlanName+"/"+sTeachingPlanName+".htm";
				showModelessDialog("../common/windowOrFullScreen_techingPlan.asp", window,"help:0;resizable:1;dialogWidth:"+screen.width*0.8+"px;dialogHeight:"+screen.height*0.5+"px;status:0;");//为了在线编辑，打开框架网页。	
				}
		}
	}
...
function fnViewText(){
	...
	if(window.oSrcElement.parentNode.parentNode===window.oSrcElement.parentNode.parentNode.parentNode.childNodes.item(0)&&window.oSrcElement.parentNode.parentNode.parentNode.parentNode.tagName.toUpperCase()==="DIV"){
		var sText="http://localhost:8000/webCourse/options/contentStart"+sPathPartForText+".asp";
		...
		if(sTextName==""){
			...
			var sHeadUrl="http://localhost:8000/webCourse/lessons/";
			var sText=sHeadUrl+"content/book"+sPathPartForText+"/"+sTextName+"/"+sTextName+".asp";
			showModelessDialog(sText, window,"help:0;resizable:1;dialogWidth:"+screen.width*0.8+"px;dialogHeight:"+screen.height*0.8+"px;status:0;");//scroll:1?
			window.oSrcElement.click();
		}
	}
					...
					if(intTarget==intLi-1){//已经是最后一个条目，从头开始查询
						for(var j=0;j<intLi;j++ ){
							if(cLi[j].getElementsByTagName("A").item(0).attributes.getNamedItem("play").nodeValue!=""){
								...
								showModelessDialog("../common/windowOrFullScreen_Animation.asp", window,"help:0;resizable:1;dialogWidth:"+screen.width*0.8+"px;dialogHeight:"+screen.height*0.5+"px;status:0;");	
								bIsHave=true;
								break;
							}
						}
				...
				if(intTarget==intLi-1){//已经是最后一个条目，从头开始查询
					for(var j=0;j<intLi;j++ ){
						if(cLi[j].getElementsByTagName("A").item(0).attributes.getNamedItem("play").nodeValue!=""){
							...
							var sHeadUrl="http://localhost:8000";
							...
							showModelessDialog(sHeadUrl+'/webCourse/common/flashPlayer/flashPlayerWindow.asp',window,"help:0;resizable:1;dialogWidth:"+iWidth+"px;dialogHeight:"+screen.height+"px;dialogLeft:"+(screen.width-iWidth)/2+"px;dialogTop:"+screen.height*0/2+"px;status:0;");	
							bIsHave=true;
							break;
						}
					}
				...
				if(intTarget==intLi-1){//已经是最后一个条目，从头开始查询
					for(var j=0;j<intLi;j++ ){
						if(cLi[j].getElementsByTagName("A").item(0).attributes.getNamedItem("playF").nodeValue!=""){
							...
							var sHeadUrl="http://localhost:8000";
							var iWidth=(4/3)*(screen.height-25-30);
							showModelessDialog(sHeadUrl+'/webCourse/common/flashPlayer/flashPlayerWindow.asp',window
			...
			if(intTarget==intLi-1){//已经是最后一个条目，从头开始查询
				for(var j=0;j<intLi;j++ ){
					if(cLi[j].getElementsByTagName("A").item(0).attributes.getNamedItem("sNote").nodeValue!=""){
						...
						var sNoteURL=sHeadUrl+"content/note/"+sNote+"/"+sNote+".asp";
						...
						showModelessDialog("../common/noteIframe.asp?sNoteURL="+sNoteURL, window,"help:0;resizable:1;dialogWidth:"+screen.width*0.8+"px;dialogHeight:"+screen.height*0.8+"px;status:0;");//为了在线编辑，打开框架网页。	
						bIsHave=true;
						break;
					}
				}
...
parent.frames("sIframeBottom").document.getElementById("sIdForm").action="../common/removeUnusedFiles.asp";
window.open("../common/removingUnusedFiles.asp", "saving","fullscreen=0,left=312,top=225,toolbar=no,location=no,directories=no,menubar=no,titlebar=no,scrollbars=no,status=no,resizable=no,copyhistory=no,width=400,height=300");//显示“正在保存...”，一直到保存目录的saveContents.asp网页的运行结果返回到该窗口，即“Saving”窗口
...
if(window.oSrcElement.parentNode.parentNode===window.oSrcElement.parentNode.parentNode.parentNode.childNodes.item(0)&&window.oSrcElement.parentNode.parentNode.parentNode.parentNode.tagName.toUpperCase()==="DIV"){
	...
	showModalDialog('../common/uploadText/uploadText.asp?sText='+sText+"&sFId="+sFId,window,"help:0;resizable:1;dialogWidth:560px;dialogHeight:540px;status:0");
}
...
if(window.oSrcElement.parentNode.parentNode===window.oSrcElement.parentNode.parentNode.parentNode.childNodes.item(0)&&window.oSrcElement.parentNode.parentNode.parentNode.parentNode.tagName.toUpperCase()==="DIV"){
	...
	showModalDialog('../common/uploadTeachingPlan/uploadTeachingPlan.asp?sTeachingPlan='+sTeachingPlan+"&sFId="+sFId,window,"help:0;resizable:1;dialogWidth:560px;dialogHeight:360px;status:0");
}
window.oSrcElement.click();
}
...
if(window.oSrcElement.parentNode.parentNode===window.oSrcElement.parentNode.parentNode.parentNode.childNodes.item(0)&&window.oSrcElement.parentNode.parentNode.parentNode.parentNode.tagName.toUpperCase()==="DIV"){
	...
	showModalDialog('../common/uploadAnimation/uploadAnimation.asp?sAnimation='+sAnimation+"&sFId="+sFId,window,"help:0;resizable:1;dialogWidth:600px;dialogHeight:360px;status:0");
	}
window.oSrcElement.click();
}
	...
	var sFId=window.oSrcElement.parentNode.attributes.getNamedItem("sFId").nodeValue;//判断是国语还是外语,sFId=""是国语,sFId="1"是外语
   	if(sFId==""){
		if( window.oSrcElement.parentNode.attributes.getNamedItem("text").nodeValue == ""){
			...
			var bWillBeRemoved=window.confirm('将删除该条目的'+window.sNativeLanguage+'课文及其源文件,如果要保留源文件，请先下载并保存！单击"确定"删除,单击"取消"终止操作！');
		   	if(bWillBeRemoved){
			   	window.oSrcElement.parentNode.setAttribute("text","");
		   		//window.oSrcElement.click();
				window.open("../common/createText.asp","sIframeContent",true);
				window.oPopup.document.getElementById("sIdUndo").disabled=false;
		   					}
		   	else{
			   	return;
		...
		if( window.oSrcElement.parentNode.attributes.getNamedItem("textF").nodeValue == ""){
			...
			var bWillBeRemoved=window.confirm('将删除该条目的'+window.sForeignLanguage+'课文及其源文件,如果要保留源文件，请先下载并保存！单击"确定"删除,单击"取消"终止操作！');
		   	if(bWillBeRemoved){
			   	window.oSrcElement.parentNode.setAttribute("textF","");
				window.open("../common/createTextForeign.asp","sIframeContent",true);
				window.oPopup.document.getElementById("sIdUndo").disabled=false;
		   					}
		   	else{
			   	return;
	...
	var sFId=window.oSrcElement.parentNode.attributes.getNamedItem("sFId").nodeValue;//判断是国语还是外语,sFId=""是国语,sFId="1"是外语
   	if(sFId==""){
		if( window.oSrcElement.parentNode.attributes.getNamedItem("teachingPlan").nodeValue == ""){
			...
			var bWillBeRemoved=window.confirm('将删除该条目的'+window.sNativeLanguage+'教案及其源文件,如果要保留源文件，请先下载并保存！单击"确定"删除,单击"取消"终止操作！');
		   	if(bWillBeRemoved){
		...
		if( window.oSrcElement.parentNode.attributes.getNamedItem("teachingPlanF").nodeValue == ""){
			...
			var bWillBeRemoved=window.confirm('将删除该条目的'+window.sForeignLanguage+'教案及其源文件,如果要保留源文件，请先下载并保存！单击"确定"删除,单击"取消"终止操作！');
		   	if(bWillBeRemoved){
	...
	var sFId=window.oSrcElement.parentNode.attributes.getNamedItem("sFId").nodeValue;//判断是国语还是外语,sFId=""是国语,sFId="1"是外语
   	if(sFId==""){
		if( window.oSrcElement.parentNode.attributes.getNamedItem("play").nodeValue == ""){
			...
			var bWillBeRemoved=window.confirm('将删除该条目的'+window.sNativeLanguage+'动画及其源文件,如果要保留源文件，请先下载并保存！单击"确定"删除,单击"取消"终止操作！');
		   	if(bWillBeRemoved){
		...
		if( window.oSrcElement.parentNode.attributes.getNamedItem("playF").nodeValue == ""){
			...
			var bWillBeRemoved=window.confirm('将删除该条目的'+window.sForeignLanguage+'动画及其源文件,如果要保留源文件，请先下载并保存！单击"确定"删除,单击"取消"终止操作！');
		   	if(bWillBeRemoved){
...
window.open("http://www.jgskjw.com/websiteCommon/update.aspx","_blank","fullscreen=no,"+"left="+(window.screen.width*0.2)/2+",top="+(window.screen.height*0.2)/2+",width="+window.screen.width*0.8+",height="+window.screen.height*0.8+",toolbar=no,location=no,directories=no,menubar=no,titlebar=no,scrollbars=yes,status=no,resizable=yes,copyhistory=no",false);
}
...
function fnWordToText(){
	showModelessDialog("../common/wordToText/wordToTextIframeInitial.asp",window,"help:0;resizable:1;dialogWidth:"+screen.width+"px;dialogHeight:"+(screen.height-168)+"px;status:0");
}

function fnTextToWord(){
	showModelessDialog("../common/textToWord/textToWordIframeInitial.asp",window,"help:0;resizable:1;dialogWidth:"+screen.width+"px;dialogHeight:"+(screen.height-168)+"px;status:0");
}

function fnMergePartResource(){
	showModelessDialog("../common/mergePartResource/mergePartResourceIframeInitial.asp",window,"help:0;resizable:1;dialogWidth:"+screen.width+"px;dialogHeight:"+(screen.height-168)+"px;status:0");
}
