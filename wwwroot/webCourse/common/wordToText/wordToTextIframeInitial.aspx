...
<table style="width:100%;height:100%;background-color:rgb(255,255,255);border:0px none;padding:0;margin:0;" id="sTableBook">
  <tr id="sTrTitle" style="width:1024;height:100">
	...
	<iframe name="sIframeBook" src="wordToTextInitial.aspx" marginwidth="0" marginheight="0" height="100%" width="100%" scrolling="no" border="0" frameborder="0">
