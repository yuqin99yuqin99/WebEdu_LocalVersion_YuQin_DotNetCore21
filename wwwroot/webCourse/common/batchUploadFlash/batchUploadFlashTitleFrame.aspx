...
<script  language="C#" runat="server">
	...
	{
	  	sPath=Server.MapPath("../../lessons/content/play").Replace("\\","\\\\");
	}
</script>
<html>
...
<table style="width:100%;height:100%;border:0px none;padding:0;margin:0;" id="sTableBook">
  <tr id="sTrTitle" style="width:100%;height:30">
    <td valign="top" width="22%">选择批量flash所在的文件夹:<br>
	<div id="oProgress"></div>
　</td>
    <td valign="top" width="48%">
	<script src="../script/showActiveX.js"></script><script>BatchUploadFlashActiveX();</script>
	</td>
    <td width="29%" valign="top">&nbsp;<input type="button" value="全选" name="sCheckAll" id="sCheckAll" onclick='parent.frames("sIframeBottom").fnCheckAll();'>
